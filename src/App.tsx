                  ...
                  <ul className="divide-y divide-gray-200">
                    {carrinho.map(item => (
                      <li key={item.id} className="py-4 flex items-center">
                        <div className="h-18 w-18 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 mr-3">
                          <img src={item.produto.imagem} alt={item.produto.nome} className="h-auto max-w-full object-cover object-center" />
                        </div>
